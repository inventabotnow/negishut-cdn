/*! Negishut v1.3.0 | (c) All rights reserved */
(()=>{var W=`/* Negishut page-affecting rules. Every feature is a class on <html>. !important throughout \u2014 must beat host CSS. */
...
`;var N=document.currentScript||document.querySelector('script[src*="negishut"]'),et=window.NGSH_CONFIG||{};function y(t){return et[t]!=null?String(et[t]):N&&N.dataset&&N.dataset[t]!=null?N.dataset[t]:""}var v={scriptSrc:N&&N.src||"",siteId:y("siteId"),org:y("org"),coordinatorName:y("coordinatorName"),coordinatorEmail:y("coordinatorEmail"),coordinatorPhone:y("coordinatorPhone"),statementUrl:y("statementUrl"),statementDate:y("statementDate"),position:y("position")==="bottom-left"?"bottom-left":"bottom-right",lang:y("lang")};var q="ngsh:settings:v1";function nt(){try{return JSON.parse(localStorage.getItem(q))||{}}catch{return{}}}function G(t){try{Object.keys(t).length?localStorage.setItem(q,JSON.stringify(t)):localStorage.removeItem(q)}catch{}}var ot=[0,1.1,1.2,1.3,1.4,1.5],it={SCRIPT:1,STYLE:1,NOSCRIPT:1,IFRAME:1,TEMPLATE:1,VIDEO:1,AUDIO:1,CANVAS:1,SVG:1},K=new WeakMap,Y=new Set,X=0,T=null,J=0;function rt(t){for(let e=t.firstChild;e;e=e.nextSibling)if(e.nodeType===3&&e.nodeValue.trim())return!0;return!1}function at(t){let e=K.get(t);if(!e){let n=parseFloat(getComputedStyle(t).fontSize);if(!n)return;e={inline:t.style.fontSize,px:n},K.set(t,e)}t.style.setProperty("font-size",(e.px*X).toFixed(2)+"px","important"),Y.add(t)}function st(t){if(!t||t.nodeType!==1||it[t.tagName]||t.id==="ngsh-root")return;rt(t)&&at(t);let e=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(o){return it[o.tagName]||o.id==="ngsh-root"?NodeFilter.FILTER_REJECT:rt(o)?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),n;for(;n=e.nextNode();)at(n)}function lt(t){X=ot[t]||ot[1],st(document.body),T||(T=new MutationObserver(()=>{clearTimeout(J),J=setTimeout(()=>st(document.body),300)}),T.observe(document.body,{childList:!0,subtree:!0}))}function dt(){T&&(T.disconnect(),T=null),clearTimeout(J),Y.forEach(t=>{let e=K.get(t);e&&(e.inline?t.style.fontSize=e.inline:t.style.removeProperty("font-size"))}),Y=new Set,X=0}var x=null,V=0,ct=0;function pt(t){ct=t.clientY,!V&&(V=requestAnimationFrame(()=>{V=0,x&&(x.style.top=ct+14+"px")}))}function mt(){x||(x=document.createElement("div"),x.id="ngsh-guide",x.setAttribute("aria-hidden","true"),x.style.top="50%",document.body.appendChild(x),document.addEventListener("mousemove",pt,{passive:!0}))}function ut(){document.removeEventListener("mousemove",pt),V&&cancelAnimationFrame(V),V=0,x&&x.remove(),x=null}var a={widgetLabel:"\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",openMenu:"\u05E4\u05EA\u05D7 \u05EA\u05E4\u05E8\u05D9\u05D8 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",closeMenu:"\u05E1\u05D2\u05D5\u05E8 \u05EA\u05E4\u05E8\u05D9\u05D8 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",menuTitle:"\u05EA\u05E4\u05E8\u05D9\u05D8 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",reset:"\u05D0\u05D9\u05E4\u05D5\u05E1 \u05D4\u05D2\u05D3\u05E8\u05D5\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",statement:"\u05D4\u05E6\u05D4\u05E8\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",back:"\u05D7\u05D6\u05E8\u05D4 \u05DC\u05EA\u05E4\u05E8\u05D9\u05D8",print:"\u05D4\u05D3\u05E4\u05E1\u05EA \u05D4\u05D4\u05E6\u05D4\u05E8\u05D4",level:"\u05E8\u05DE\u05D4",expiredTooltip:"\u05E9\u05D9\u05E8\u05D5\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05D0\u05D9\u05E0\u05D5 \u05E4\u05E2\u05D9\u05DC",expiredTitle:"\u05E9\u05D9\u05E8\u05D5\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05D0\u05D9\u05E0\u05D5 \u05E4\u05E2\u05D9\u05DC",expiredBody:"\u05E9\u05D9\u05E8\u05D5\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05D1\u05D0\u05EA\u05E8 \u05D6\u05D4 \u05D0\u05D9\u05E0\u05D5 \u05E4\u05E2\u05D9\u05DC \u05DB\u05E8\u05D2\u05E2. \u05D1\u05E2\u05DC \u05D4\u05D0\u05EA\u05E8 \u05DE\u05D5\u05D6\u05DE\u05DF \u05DC\u05D4\u05E4\u05E2\u05D9\u05DC \u05D0\u05D5 \u05DC\u05D7\u05D3\u05E9 \u05D0\u05EA \u05D4\u05DE\u05E0\u05D5\u05D9:",expiredLinkLabel:"negishoot.com",expiredLinkUrl:"https://negishoot.com",activeBrand:"\u05E9\u05D9\u05E8\u05D5\u05EA \u05E4\u05E2\u05D9\u05DC",expiredBrand:"\u05D4\u05E9\u05D9\u05E8\u05D5\u05EA \u05DE\u05D5\u05E9\u05D4\u05D4",brandName:"\u05EA\u05D5\u05E1\u05E3 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05DC\u05D0\u05EA\u05E8 Negishoot",brandUrl:"https://negishoot.com/",missingAlt:"\u05D7\u05E1\u05E8 \u05EA\u05D9\u05D0\u05D5\u05E8 \u05DC\u05EA\u05DE\u05D5\u05E0\u05D4",skipToContent:"\u05D3\u05DC\u05D2 \u05DC\u05EA\u05D5\u05DB\u05DF \u05D4\u05DE\u05E8\u05DB\u05D6\u05D9",features:{fontSize:"\u05D4\u05D2\u05D3\u05DC\u05EA \u05D8\u05E7\u05E1\u05D8",zoom:"\u05D6\u05D5\u05DD \u05EA\u05E6\u05D5\u05D2\u05D4",contrastDark:"\u05E0\u05D9\u05D2\u05D5\u05D3\u05D9\u05D5\u05EA \u05DB\u05D4\u05D4",contrastLight:"\u05E0\u05D9\u05D2\u05D5\u05D3\u05D9\u05D5\u05EA \u05D1\u05D4\u05D9\u05E8\u05D4",invert:"\u05D4\u05D9\u05E4\u05D5\u05DA \u05E6\u05D1\u05E2\u05D9\u05DD",gray:"\u05D2\u05D5\u05D5\u05E0\u05D9 \u05D0\u05E4\u05D5\u05E8",font:"\u05E4\u05D5\u05E0\u05D8 \u05E7\u05E8\u05D9\u05D0",links:"\u05D4\u05D3\u05D2\u05E9\u05EA \u05E7\u05D9\u05E9\u05D5\u05E8\u05D9\u05DD",spacing:"\u05E8\u05D9\u05D5\u05D5\u05D7 \u05D8\u05E7\u05E1\u05D8",cursor:"\u05E1\u05DE\u05DF \u05D2\u05D3\u05D5\u05DC",kbfocus:"\u05E0\u05D9\u05D5\u05D5\u05D8 \u05DE\u05E7\u05DC\u05D3\u05EA",noanim:"\u05E2\u05E6\u05D9\u05E8\u05EA \u05D4\u05D1\u05D4\u05D5\u05D1\u05D9\u05DD",guide:"\u05E1\u05E8\u05D2\u05DC \u05E7\u05E8\u05D9\u05D0\u05D4",alts:"\u05EA\u05D9\u05D0\u05D5\u05E8\u05D9 \u05EA\u05DE\u05D5\u05E0\u05D5\u05EA"}};function ht(t){let e=(t.org||"\u05D1\u05E2\u05DC\u05D9 \u05D4\u05D0\u05EA\u05E8").trim()||"\u05D1\u05E2\u05DC\u05D9 \u05D4\u05D0\u05EA\u05E8",n=[];n.push({ps:[e+" \u05E8\u05D5\u05D0\u05D9\u05DD \u05D7\u05E9\u05D9\u05D1\u05D5\u05EA \u05E8\u05D1\u05D4 \u05D1\u05DE\u05EA\u05DF \u05E9\u05D9\u05E8\u05D5\u05EA \u05E9\u05D5\u05D5\u05D9\u05D5\u05E0\u05D9, \u05DE\u05DB\u05D1\u05D3, \u05E0\u05D2\u05D9\u05E9 \u05D5\u05DE\u05E7\u05E6\u05D5\u05E2\u05D9 \u05DC\u05DB\u05DC\u05DC \u05D4\u05DC\u05E7\u05D5\u05D7\u05D5\u05EA \u05D5\u05D4\u05D2\u05D5\u05DC\u05E9\u05D9\u05DD, \u05D5\u05D1\u05DB\u05DC\u05DC \u05D6\u05D4 \u05D0\u05E0\u05E9\u05D9\u05DD \u05E2\u05DD \u05DE\u05D5\u05D2\u05D1\u05DC\u05D5\u05EA, \u05DE\u05EA\u05D5\u05DA \u05D0\u05DE\u05D5\u05E0\u05D4 \u05DB\u05D9 \u05DC\u05DB\u05DC \u05D0\u05D3\u05DD \u05DE\u05D2\u05D9\u05E2\u05D4 \u05D4\u05D6\u05DB\u05D5\u05EA \u05DC\u05D7\u05D9\u05D5\u05EA \u05D1\u05E9\u05D5\u05D5\u05D9\u05D5\u05DF, \u05D1\u05DB\u05D1\u05D5\u05D3, \u05D1\u05E0\u05D5\u05D7\u05D5\u05EA \u05D5\u05D1\u05E2\u05E6\u05DE\u05D0\u05D5\u05EA.",'\u05D4\u05E6\u05D4\u05E8\u05D4 \u05D6\u05D5 \u05E0\u05DB\u05EA\u05D1\u05D4 \u05D1\u05D4\u05EA\u05D0\u05DD \u05DC\u05D7\u05D5\u05E7 \u05E9\u05D5\u05D5\u05D9\u05D5\u05DF \u05D6\u05DB\u05D5\u05D9\u05D5\u05EA \u05DC\u05D0\u05E0\u05E9\u05D9\u05DD \u05E2\u05DD \u05DE\u05D5\u05D2\u05D1\u05DC\u05D5\u05EA, \u05D4\u05EA\u05E9\u05E0"\u05D7-1998, \u05D5\u05DC\u05EA\u05E7\u05E0\u05D5\u05EA \u05E9\u05D5\u05D5\u05D9\u05D5\u05DF \u05D6\u05DB\u05D5\u05D9\u05D5\u05EA \u05DC\u05D0\u05E0\u05E9\u05D9\u05DD \u05E2\u05DD \u05DE\u05D5\u05D2\u05D1\u05DC\u05D5\u05EA (\u05D4\u05EA\u05D0\u05DE\u05D5\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05DC\u05E9\u05D9\u05E8\u05D5\u05EA), \u05D4\u05EA\u05E9\u05E2"\u05D2-2013.']}),n.push({h:"\u05D4\u05E0\u05D2\u05E9\u05EA \u05D4\u05D0\u05EA\u05E8",ps:['\u05D0\u05E0\u05D5 \u05E4\u05D5\u05E2\u05DC\u05D9\u05DD \u05DC\u05D4\u05E0\u05D2\u05E9\u05EA \u05D4\u05D0\u05EA\u05E8 \u05D1\u05D4\u05EA\u05D0\u05DD \u05DC\u05EA\u05E7\u05DF \u05D4\u05D9\u05E9\u05E8\u05D0\u05DC\u05D9 \u05EA"\u05D9 5568 "\u05E7\u05D5\u05D5\u05D9\u05DD \u05DE\u05E0\u05D7\u05D9\u05DD \u05DC\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05EA\u05DB\u05E0\u05D9\u05DD \u05D1\u05D0\u05D9\u05E0\u05D8\u05E8\u05E0\u05D8" \u05D1\u05E8\u05DE\u05EA AA, \u05D4\u05DE\u05D1\u05D5\u05E1\u05E1 \u05E2\u05DC \u05D4\u05E0\u05D7\u05D9\u05D5\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA WCAG 2.0 \u05E9\u05DC \u05D0\u05E8\u05D2\u05D5\u05DF W3C \u05D4\u05D1\u05D9\u05E0\u05DC\u05D0\u05D5\u05DE\u05D9.',"\u05D1\u05D0\u05EA\u05E8 \u05DE\u05D5\u05D8\u05DE\u05E2 \u05E8\u05DB\u05D9\u05D1 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05D4\u05DE\u05D0\u05E4\u05E9\u05E8, \u05D1\u05D9\u05DF \u05D4\u05D9\u05EA\u05E8: \u05D4\u05D2\u05D3\u05DC\u05EA \u05D8\u05E7\u05E1\u05D8 \u05D5\u05D6\u05D5\u05DD \u05EA\u05E6\u05D5\u05D2\u05D4, \u05D4\u05EA\u05D0\u05DE\u05EA \u05E0\u05D9\u05D2\u05D5\u05D3\u05D9\u05D5\u05EA \u05D5\u05D4\u05D9\u05E4\u05D5\u05DA \u05E6\u05D1\u05E2\u05D9\u05DD, \u05D2\u05D5\u05E4\u05DF \u05E7\u05E8\u05D9\u05D0, \u05D4\u05D3\u05D2\u05E9\u05EA \u05E7\u05D9\u05E9\u05D5\u05E8\u05D9\u05DD, \u05E8\u05D9\u05D5\u05D5\u05D7 \u05D8\u05E7\u05E1\u05D8, \u05E1\u05DE\u05DF \u05E2\u05DB\u05D1\u05E8 \u05DE\u05D5\u05D2\u05D3\u05DC, \u05D4\u05D1\u05DC\u05D8\u05EA \u05DE\u05D9\u05E7\u05D5\u05D3 \u05DE\u05E7\u05DC\u05D3\u05EA, \u05E2\u05E6\u05D9\u05E8\u05EA \u05D0\u05E0\u05D9\u05DE\u05E6\u05D9\u05D5\u05EA \u05D5\u05D4\u05D1\u05D4\u05D5\u05D1\u05D9\u05DD, \u05E1\u05E8\u05D2\u05DC \u05E7\u05E8\u05D9\u05D0\u05D4, \u05D4\u05E6\u05D2\u05EA \u05EA\u05D9\u05D0\u05D5\u05E8\u05D9 \u05EA\u05DE\u05D5\u05E0\u05D5\u05EA \u05D5\u05E7\u05D9\u05E9\u05D5\u05E8 \u05D3\u05D9\u05DC\u05D5\u05D2 \u05DC\u05EA\u05D5\u05DB\u05DF \u05D4\u05DE\u05E8\u05DB\u05D6\u05D9. \u05D4\u05D4\u05D2\u05D3\u05E8\u05D5\u05EA \u05E0\u05E9\u05DE\u05E8\u05D5\u05EA \u05D1\u05D3\u05E4\u05D3\u05E4\u05DF \u05D4\u05D2\u05D5\u05DC\u05E9."]}),n.push({h:"\u05DE\u05D2\u05D1\u05DC\u05D5\u05EA \u05D9\u05D3\u05D5\u05E2\u05D5\u05EA",ps:["\u05D0\u05E0\u05D5 \u05E2\u05D5\u05E9\u05D9\u05DD \u05DB\u05DC \u05DE\u05D0\u05DE\u05E5 \u05DC\u05D4\u05E0\u05D2\u05D9\u05E9 \u05D0\u05EA \u05DB\u05DC\u05DC \u05D4\u05D3\u05E4\u05D9\u05DD \u05D5\u05D4\u05EA\u05DB\u05E0\u05D9\u05DD \u05D1\u05D0\u05EA\u05E8. \u05E2\u05DD \u05D6\u05D0\u05EA, \u05D9\u05D9\u05EA\u05DB\u05DF \u05E9\u05D9\u05D9\u05DE\u05E6\u05D0\u05D5 \u05D7\u05DC\u05E7\u05D9\u05DD \u05D0\u05D5 \u05EA\u05DB\u05E0\u05D9\u05DD \u05E9\u05D8\u05E8\u05DD \u05D4\u05D5\u05E0\u05D2\u05E9\u05D5 \u05D1\u05DE\u05DC\u05D5\u05D0\u05DD, \u05DC\u05E8\u05D1\u05D5\u05EA \u05EA\u05DB\u05E0\u05D9\u05DD \u05D4\u05DE\u05E1\u05D5\u05E4\u05E7\u05D9\u05DD \u05E2\u05DC \u05D9\u05D3\u05D9 \u05E6\u05D3\u05D3\u05D9\u05DD \u05E9\u05DC\u05D9\u05E9\u05D9\u05D9\u05DD. \u05D0\u05DD \u05E0\u05EA\u05E7\u05DC\u05EA\u05DD \u05D1\u05D1\u05E2\u05D9\u05D9\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u2013 \u05E0\u05E9\u05DE\u05D7 \u05E9\u05EA\u05E2\u05D3\u05DB\u05E0\u05D5 \u05D0\u05D5\u05EA\u05E0\u05D5 \u05D5\u05E0\u05E4\u05E2\u05DC \u05DC\u05EA\u05D9\u05E7\u05D5\u05E0\u05D4 \u05D1\u05D4\u05E7\u05D3\u05DD \u05D4\u05D0\u05E4\u05E9\u05E8\u05D9."]});let o=[];t.coordinatorName&&o.push("\u05E9\u05DD: "+t.coordinatorName),t.coordinatorPhone&&o.push("\u05D8\u05DC\u05E4\u05D5\u05DF: "+t.coordinatorPhone),t.coordinatorEmail&&o.push('\u05D3\u05D5\u05D0"\u05DC: '+t.coordinatorEmail),o.length&&n.push({h:"\u05E8\u05DB\u05D6/\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",ps:["\u05DC\u05DB\u05DC \u05E9\u05D0\u05DC\u05D4, \u05D1\u05E7\u05E9\u05D4 \u05D0\u05D5 \u05D3\u05D9\u05D5\u05D5\u05D7 \u05D1\u05E0\u05D5\u05E9\u05D0 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05E0\u05D9\u05EA\u05DF \u05DC\u05E4\u05E0\u05D5\u05EA \u05D0\u05DC \u05E8\u05DB\u05D6/\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05E9\u05DC\u05E0\u05D5:"],list:o}),n.push({h:"\u05DE\u05E9\u05D5\u05D1 \u05D5\u05E4\u05E0\u05D9\u05D5\u05EA \u05D1\u05E0\u05D5\u05E9\u05D0 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",ps:["\u05D0\u05DD \u05E0\u05EA\u05E7\u05DC\u05EA\u05DD \u05D1\u05E7\u05D5\u05E9\u05D9 \u05D1\u05D2\u05DC\u05D9\u05E9\u05D4 \u05D1\u05D0\u05EA\u05E8 \u05D0\u05D5 \u05D1\u05E7\u05D1\u05DC\u05EA \u05E9\u05D9\u05E8\u05D5\u05EA, \u05E0\u05E9\u05DE\u05D7 \u05D0\u05DD \u05EA\u05E4\u05E0\u05D5 \u05D0\u05DC\u05D9\u05E0\u05D5"+(o.length?" \u05D1\u05D0\u05DE\u05E6\u05E2\u05D5\u05EA \u05E4\u05E8\u05D8\u05D9 \u05D4\u05E7\u05E9\u05E8 \u05E9\u05DC\u05E2\u05D9\u05DC":"")+". \u05D0\u05E0\u05D0 \u05E6\u05E8\u05E4\u05D5 \u05EA\u05D9\u05D0\u05D5\u05E8 \u05E9\u05DC \u05D4\u05D1\u05E2\u05D9\u05D4, \u05DB\u05EA\u05D5\u05D1\u05EA \u05D4\u05D3\u05E3 \u05E9\u05D1\u05D5 \u05E0\u05EA\u05E7\u05DC\u05EA\u05DD \u05D1\u05D4, \u05D5\u05E1\u05D5\u05D2 \u05D4\u05D3\u05E4\u05D3\u05E4\u05DF \u05D5\u05D4\u05D8\u05DB\u05E0\u05D5\u05DC\u05D5\u05D2\u05D9\u05D4 \u05D4\u05DE\u05E1\u05D9\u05D9\u05E2\u05EA \u05E9\u05D1\u05D4\u05DD \u05D4\u05E9\u05EA\u05DE\u05E9\u05EA\u05DD \u2013 \u05DB\u05DA \u05E0\u05D5\u05DB\u05DC \u05DC\u05D8\u05E4\u05DC \u05D1\u05E4\u05E0\u05D9\u05D9\u05D4 \u05D1\u05D9\u05E2\u05D9\u05DC\u05D5\u05EA."]});let i=t.statementDate?"\u05D4\u05D4\u05E6\u05D4\u05E8\u05D4 \u05E2\u05D5\u05D3\u05DB\u05E0\u05D4 \u05DC\u05D0\u05D7\u05E8\u05D5\u05E0\u05D4 \u05D1\u05EA\u05D0\u05E8\u05D9\u05DA: "+t.statementDate:"",r=[];return i&&r.push(i),r.push("\u05D4\u05E6\u05D4\u05E8\u05D4 \u05D6\u05D5 \u05D4\u05D5\u05E4\u05E7\u05D4 \u05D1\u05D0\u05DE\u05E6\u05E2\u05D5\u05EA \u05EA\u05D5\u05E1\u05E3 \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA Negishoot (negishoot.com). \u05D4\u05D0\u05D7\u05E8\u05D9\u05D5\u05EA \u05D4\u05DE\u05E9\u05E4\u05D8\u05D9\u05EA \u05E2\u05DC \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05D4\u05D0\u05EA\u05E8 \u05D5\u05EA\u05DB\u05E0\u05D9\u05D5 \u05D7\u05DC\u05D4 \u05E2\u05DC \u05D1\u05E2\u05DC\u05D9 \u05D4\u05D0\u05EA\u05E8."),n.push({ps:r}),n}var Z=[],P=null;function gt(){Z.forEach(t=>t.remove()),Z=[]}function ft(){gt(),document.querySelectorAll("img").forEach(t=>{let e=t.getBoundingClientRect();if(e.width<40||e.height<40)return;let n=(t.getAttribute("alt")||"").trim(),o=document.createElement("div");o.className="ngsh-alt-badge"+(n?"":" ngsh-alt-missing"),o.setAttribute("aria-hidden","true"),o.textContent=n||a.missingAlt,o.style.top=e.top+window.scrollY+4+"px",o.style.left=e.left+window.scrollX+4+"px",document.body.appendChild(o),Z.push(o)})}function bt(){ft();let t=0;P=()=>{clearTimeout(t),t=setTimeout(ft,400)},window.addEventListener("resize",P)}function xt(){P&&window.removeEventListener("resize",P),P=null,gt()}function Ct(){document.querySelectorAll("video, audio").forEach(t=>{try{t.paused||t.pause()}catch{}})}var I=document.documentElement;function k(t){return{apply:()=>I.classList.add("ngsh-"+t),remove:()=>I.classList.remove("ngsh-"+t)}}function Ut(t,e){let n=()=>{for(let o=1;o<=e;o++)I.classList.remove("ngsh-"+t+"-"+o)};return{apply:o=>{n(),o>0&&I.classList.add("ngsh-"+t+"-"+o)},remove:n}}var D=[{id:"fontSize",kind:"steps",max:5,icon:"fontSize",apply:lt,remove:dt},{id:"zoom",kind:"steps",max:3,icon:"zoom",...Ut("zoom",3)},{id:"contrastDark",kind:"toggle",group:"colors",icon:"moon",...k("contrast-dark")},{id:"contrastLight",kind:"toggle",group:"colors",icon:"sun",...k("contrast-light")},{id:"invert",kind:"toggle",group:"colors",icon:"invert",...k("invert")},{id:"gray",kind:"toggle",group:"colors",icon:"gray",...k("gray")},{id:"font",kind:"toggle",icon:"font",...k("font")},{id:"links",kind:"toggle",icon:"link",...k("links")},{id:"spacing",kind:"toggle",icon:"spacing",...k("spacing")},{id:"cursor",kind:"toggle",icon:"cursor",...k("cursor")},{id:"kbfocus",kind:"toggle",icon:"keyboard",...k("kbfocus")},{id:"noanim",kind:"toggle",icon:"pause",apply(){I.classList.add("ngsh-noanim"),Ct()},remove(){I.classList.remove("ngsh-noanim")}},{id:"guide",kind:"toggle",icon:"ruler",apply:mt,remove:ut},{id:"alts",kind:"toggle",icon:"image",apply:bt,remove:xt}],m={};function vt(){m=nt(),D.forEach(t=>{let e=m[t.id];if(e)try{t.apply(e===!0?void 0:Number(e))}catch{delete m[t.id]}})}function yt(t){return m[t]||0}function kt(t){if(t.kind==="steps"){let n=((Number(m[t.id])||0)+1)%(t.max+1);n===0?(t.remove(),delete m[t.id]):(t.apply(n),m[t.id]=n)}else m[t.id]?(t.remove(),delete m[t.id]):(t.group&&D.forEach(e=>{e!==t&&e.group===t.group&&m[e.id]&&(e.remove(),delete m[e.id])}),t.apply(),m[t.id]=!0);G(m)}function Et(){D.forEach(t=>{m[t.id]&&t.remove()}),m={},G(m)}function Lt(){if(document.querySelector("a.ngsh-skip"))return;let t=document.querySelector('main, [role="main"]')||document.getElementById("main")||document.getElementById("content")||document.getElementById("primary")||document.querySelector("h1");if(!t)return;t.id||(t.id="ngsh-main"),t.hasAttribute("tabindex")||t.setAttribute("tabindex","-1");let e=document.createElement("a");e.className="ngsh-skip",e.href="#"+t.id,e.textContent=a.skipToContent,e.addEventListener("click",()=>{try{t.focus()}catch{}}),document.body.insertBefore(e,document.body.firstChild)}var $=`:host {
  all: initial;
}
* {
...
</svg>`;var wt="http://www.w3.org/2000/svg",St={person:"M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm9 7h-6v13h-2v-6h-2v6H9V9H3V7h18v2z",close:"M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z",back:"M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z",doc:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z",print:"M19 8H5a3 3 0 0 0-3 3v6h4v4h12v-4h4v-6a3 3 0 0 0-3-3zm-3 11H8v-5h8v5zm3-7a1 1 0 1 1 0-2 1 1 0 0 1 0 2zM18 3H6v4h12V3z",reset:"M17.65 6.35A7.95 7.95 0 0 0 12 4a8 8 0 1 0 8 8h-2a6 6 0 1 1-1.76-4.24L13 11h7V4l-2.35 2.35z",fontSize:"M9 4v3h5v12h3V7h5V4H9zM3 12h3v7h3v-7h3V9H3v3z",zoom:"M15.5 14h-.79l-.28-.27A6.47 6.47 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14zm2.5-4h-2v2H9v-2H7V9h2V7h1v2h2v1z",moon:"M12 3a9 9 0 1 0 9 9c0-.46-.04-.92-.1-1.36a5.39 5.39 0 0 1-4.4 2.26 5.4 5.4 0 0 1-3.14-9.8c-.44-.06-.9-.1-1.36-.1z",sun:"M12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0-5 2.39 3.61h-4.78L12 2zm0 20-2.39-3.61h4.78L12 22zM2 12l3.61-2.39v4.78L2 12zm20 0-3.61 2.39V9.61L22 12z",invert:"M17.66 7.93 12 2.27 6.34 7.93a8 8 0 1 0 11.32 0zM12 19.59c-1.6 0-3.11-.62-4.24-1.76A5.95 5.95 0 0 1 6 13.59c0-1.6.62-3.11 1.76-4.24L12 5.1v14.49z",gray:"M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 18V4a8 8 0 0 1 0 16z",font:"M5 4v3h5.5v12h3V7H19V4H5z",link:"M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7a5 5 0 0 0 0 10h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4a5 5 0 0 0 0-10z",spacing:"M6 7h2.5L5 3.5 1.5 7H4v10H1.5L5 20.5 8.5 17H6V7zm4-2v2h12V5H10zm0 14h12v-2H10v2zm0-6h12v-2H10v2z",cursor:"M6 2l13 11.5h-7.8L8.6 21z",keyboard:"M20 5H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zM8 9h2v2H8V9zm0 3h2v2H8v-2zM5 9h2v2H5V9zm0 3h2v2H5v-2zm11 5H8v-2h8v2zm3-3h-2v-2h2v2zm0-3h-2V9h2v2zm-5-2h2v2h-2V9zm0 3h2v2h-2v-2z",pause:"M6 19h4V5H6v14zm8-14v14h4V5h-4z",ruler:"M2 16h20v5H2v-5zm3 1v2h1v-2H5zm4 0v2h1v-2H9zm4 0v2h1v-2h-1zm4 0v2h1v-2h-1zM4 3h7v10H4z",image:"M21 19V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2zM8.5 13.5l2.5 3 3.5-4.5 4.5 6H5l3.5-4.5z"};function C(t,e){let n=document.createElementNS(wt,"svg");n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("width",e||24),n.setAttribute("height",e||24),n.setAttribute("fill","currentColor"),n.setAttribute("aria-hidden","true"),n.setAttribute("focusable","false");let o=document.createElementNS(wt,"path");return o.setAttribute("d",St[t]||St.doc),n.appendChild(o),n}function At(t,e){let n=e.createDocumentFragment();return ht(t).forEach(o=>{if(o.h){let i=e.createElement("h3");i.textContent=o.h,n.appendChild(i)}if((o.ps||[]).forEach(i=>{let r=e.createElement("p");r.textContent=i,n.appendChild(r)}),o.list){let i=e.createElement("ul");o.list.forEach(r=>{let s=e.createElement("li");s.textContent=r,i.appendChild(s)}),n.appendChild(i)}}),n}function qt(t){let e=document.createElement("iframe");e.setAttribute("aria-hidden","true"),e.style.cssText="position:fixed;width:0;height:0;border:0;visibility:hidden;",document.body.appendChild(e);let n=e.contentDocument;n.open(),n.write('<!doctype html><html dir="rtl" lang="he"><head><meta charset="utf-8"><title>\u05D4\u05E6\u05D4\u05E8\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA</title></head><body></body></html>'),n.close();let o=n.createElement("style");o.textContent="body{font-family:Arial,sans-serif;line-height:1.7;padding:28px;color:#000}h1{font-size:22px;margin-bottom:12px}h3{font-size:16px;margin:16px 0 4px}p{margin:6px 0}ul{margin:6px 24px 6px 0}",n.head.appendChild(o);let i=n.createElement("h1");i.textContent=a.statement,n.body.appendChild(i),n.body.appendChild(At(t,n)),e.contentWindow.focus(),e.contentWindow.print(),setTimeout(()=>e.remove(),3e3)}function Mt(t){let e=document.createElement("div");e.className="statement",e.appendChild(At(t,document));let n=document.createElement("button");n.type="button",n.className="wide",n.appendChild(C("print",18));let o=document.createElement("span");return o.textContent=a.print,n.appendChild(o),n.addEventListener("click",()=>qt(t)),e.appendChild(n),e}function Ht(t,e){let n=document.createElement("div");n.className="panel",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label",a.menuTitle),n.hidden=!0;let o=document.createElement("div");o.className="header";let i=document.createElement("h2");i.textContent=a.menuTitle;let r=document.createElement("div");r.className="hbtns";let s=document.createElement("button");s.type="button",s.className="iconbtn",s.setAttribute("aria-label",a.back),s.appendChild(C("back",20)),s.hidden=!0;let c=document.createElement("button");c.type="button",c.className="iconbtn",c.setAttribute("aria-label",a.closeMenu),c.appendChild(C("close",20)),c.addEventListener("click",e),r.appendChild(s),r.appendChild(c),o.appendChild(i),o.appendChild(r),n.appendChild(o);let l=document.createElement("div"),g=document.createElement("div");g.className="grid";let z=[];D.forEach(d=>{let h=document.createElement("button");h.type="button",h.className="tile",d.kind==="toggle"&&h.setAttribute("role","switch"),h.appendChild(C(d.icon,24));let Q=document.createElement("span");Q.textContent=a.features[d.id],h.appendChild(Q);let H=null;if(d.kind==="steps"){H=document.createElement("span"),H.className="steps",H.setAttribute("aria-hidden","true");for(let L=0;L<d.max;L++)H.appendChild(document.createElement("span"));h.appendChild(H)}let tt=()=>{let L=yt(d.id);if(d.kind==="toggle")h.setAttribute("aria-checked",L?"true":"false"),h.classList.toggle("on",!!L);else{let j=Number(L)||0;h.classList.toggle("on",j>0),h.setAttribute("aria-label",a.features[d.id]+", "+a.level+" "+j+" \u05DE\u05EA\u05D5\u05DA "+d.max),Array.prototype.forEach.call(H.children,(Ft,Pt)=>Ft.classList.toggle("f",Pt<j))}};h.addEventListener("click",()=>{kt(d),z.forEach(L=>L())}),z.push(tt),tt(),g.appendChild(h)}),l.appendChild(g);let w=document.createElement("div");w.className="footer";let f;t.statementUrl?(f=document.createElement("a"),f.href=t.statementUrl,f.target="_blank",f.rel="noopener"):(f=document.createElement("button"),f.type="button"),f.className="wide",f.appendChild(C("doc",18));let S=document.createElement("span");S.textContent=a.statement,f.appendChild(S),w.appendChild(f);let E=document.createElement("button");E.type="button",E.className="wide",E.appendChild(C("reset",18));let p=document.createElement("span");p.textContent=a.reset,E.appendChild(p),E.addEventListener("click",()=>{Et(),z.forEach(d=>d())}),w.appendChild(E),l.appendChild(w),n.appendChild(l);let u=null,b=document.createElement("div");b.className="expired-box";let B=document.createElement("h3");B.textContent=a.expiredTitle;let A=document.createElement("p");A.textContent=a.expiredBody;let F=document.createElement("a");F.href=a.expiredLinkUrl,F.target="_blank",F.rel="noopener",F.textContent=a.expiredLinkLabel,b.appendChild(B),b.appendChild(A),b.appendChild(F),b.hidden=!0,n.appendChild(b);let R=document.createElement("div");R.className="brand";let M=document.createElement("a");M.href=a.brandUrl+"?utm_source=widget&utm_medium=badge&ref="+encodeURIComponent(t.siteId||location.hostname),M.target="_blank",M.rel="noopener",M.textContent=a.brandName,M.setAttribute("aria-label",a.brandName+" \u2014 "+a.activeBrand);let _=document.createElement("span");_.textContent=" \xB7 "+a.activeBrand,R.appendChild(M),R.appendChild(_),n.appendChild(R);let U=!1;function O(d){U&&(d="expired"),l.hidden=d!=="menu",u&&(u.hidden=d!=="statement"),b.hidden=d!=="expired",s.hidden=d!=="statement"}t.statementUrl||f.addEventListener("click",()=>{u||(u=Mt(t),u.hidden=!0,n.insertBefore(u,b)),O("statement"),s.focus()}),s.addEventListener("click",()=>{O("menu"),c.focus()});function It(d){U=d==="expired",U?(O("expired"),_.textContent=" \xB7 "+a.expiredBrand):(O("menu"),_.textContent=" \xB7 "+a.activeBrand,z.forEach(h=>h()))}function Bt(){c.focus()}return{el:n,refresh:It,focusFirst:Bt}}function Gt(){try{let e=new DOMParser().parseFromString(zt,"image/svg+xml").documentElement;return e.nodeName!=="svg"?C("person",32):(e.setAttribute("width","40"),e.setAttribute("height","40"),e.setAttribute("aria-hidden","true"),e.setAttribute("focusable","false"),document.importNode(e,!0))}catch{return C("person",32)}}function Nt(t){let e=document.createElement("div");e.id="ngsh-root";let n=t.position==="bottom-left"?"left":"right";e.style.cssText="position:fixed;bottom:16px;"+n+":16px;z-index:2147483646;";let o=e.attachShadow({mode:"open"});try{let p=new CSSStyleSheet;p.replaceSync($),o.adoptedStyleSheets=[p]}catch{let u=document.createElement("style");u.textContent=$,o.appendChild(u)}let i=document.createElement("div");i.className="wrap pos-"+n,i.setAttribute("dir","rtl"),i.setAttribute("lang","he");let r=document.createElement("button");r.type="button",r.className="btn",r.title=a.widgetLabel,r.setAttribute("aria-label",a.openMenu),r.setAttribute("aria-haspopup","dialog"),r.setAttribute("aria-expanded","false"),r.appendChild(Gt()),i.appendChild(r),o.appendChild(i);let s=null,c=!1,l="active";function g(){return s.el.querySelectorAll("button:not([hidden]), a[href]")}function z(p){if(!c)return;if(p.key==="Escape"){p.stopPropagation(),S();return}if(p.key!=="Tab")return;let u=g();if(!u.length)return;let b=u[0],B=u[u.length-1],A=o.activeElement;p.shiftKey&&(A===b||!A)?(p.preventDefault(),B.focus()):!p.shiftKey&&A===B&&(p.preventDefault(),b.focus())}function w(p){c&&p.composedPath&&!p.composedPath().includes(e)&&S()}function f(){s||(s=Ht(t,S),i.appendChild(s.el),s.el.addEventListener("keydown",z)),s.refresh(l),s.el.hidden=!1,c=!0,r.setAttribute("aria-expanded","true"),r.setAttribute("aria-label",a.closeMenu),s.focusFirst(),document.addEventListener("click",w,!0)}function S(){s&&(s.el.hidden=!0,c=!1,r.setAttribute("aria-expanded","false"),r.setAttribute("aria-label",a.openMenu),document.removeEventListener("click",w,!0),r.focus())}r.addEventListener("click",()=>c?S():f());function E(p){l=p==="expired"?"expired":"active",i.classList.toggle("expired",l==="expired"),r.title=l==="expired"?a.expiredTooltip:a.widgetLabel,c&&s.refresh(l)}return{host:e,setLicense:E}}var Kt="https://negishut-api.solaitions.workers.dev/v1/check",Tt="ngsh:lic:v1";function Vt(t,e){let n=null;try{n=JSON.parse(localStorage.getItem(Tt))}catch{}let o=n&&(n.v==="active"||n.v==="expired")?n.v:"active";e(o);let i=location.hostname;if(!i||i==="localhost"||i==="127.0.0.1"||location.protocol==="file:")return;let r=n&&n.v==="active"?1296e6:864e5;if(n&&n.t&&Date.now()-n.t<r)return;let s=null,c=0;try{s=new AbortController,c=setTimeout(()=>s.abort(),3e3)}catch{}fetch(Kt+"?site="+encodeURIComponent(i)+"&id="+encodeURIComponent(t.siteId||""),{mode:"cors",signal:s&&s.signal}).then(l=>l.ok?l.json():null).then(l=>{if(clearTimeout(c),!l||!l.status)return;let g=null;if(l.status==="active"?g="active":(l.status==="expired"||l.status==="unknown")&&(g="expired"),!!g){try{localStorage.setItem(Tt,JSON.stringify({v:g,t:Date.now()}))}catch{}g!==o&&e(g)}}).catch(()=>{clearTimeout(c)})}(function(){if(window.__ngshLoaded)return;window.__ngshLoaded=!0;function t(){try{let o=new CSSStyleSheet;o.replaceSync(W),document.adoptedStyleSheets=[...document.adoptedStyleSheets,o]}catch{let i=document.createElement("style");i.setAttribute("data-ngsh",""),i.textContent=W,(document.head||document.documentElement).appendChild(i)}}function e(){try{if(!v.siteId||!v.scriptSrc)return;let o=new URLSearchParams(location.search).get("ngsh-audit"),i="";try{i=sessionStorage.getItem("ngsh:audit")||""}catch{}if(o===v.siteId){i=o;try{sessionStorage.setItem("ngsh:audit",i)}catch{}}if(i!==v.siteId)return;let r=document.createElement("script");r.src=v.scriptSrc.replace(/negishut(\.min)?\.js([?#].*)?$/,"negishut-audit.js"),r.defer=!0,document.head.appendChild(r)}catch{}}function n(){t(),v.lang&&!document.documentElement.getAttribute("lang")&&document.documentElement.setAttribute("lang",v.lang),Lt(),vt();let o=Nt(v);document.body.appendChild(o.host),Vt(v,o.setLicense),e()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();})();
