/*! Negishut v1.1.1 | (c) All rights reserved */
(()=>{var R=`/* Negishut page-affecting rules. Every feature is a class on <html>. !important throughout \u2014 must beat host CSS. */
...
`;var D=document.currentScript||document.querySelector('script[src*="negishut"]'),Z=window.NGSH_CONFIG||{};function C(t){return Z[t]!=null?String(Z[t]):D&&D.dataset&&D.dataset[t]!=null?D.dataset[t]:""}var I={siteId:C("siteId"),org:C("org"),coordinatorName:C("coordinatorName"),coordinatorEmail:C("coordinatorEmail"),coordinatorPhone:C("coordinatorPhone"),statementUrl:C("statementUrl"),statementDate:C("statementDate"),position:C("position")==="bottom-left"?"bottom-left":"bottom-right",lang:C("lang")};var _="ngsh:settings:v1";function Q(){try{return JSON.parse(localStorage.getItem(_))||{}}catch{return{}}}function j(t){try{Object.keys(t).length?localStorage.setItem(_,JSON.stringify(t)):localStorage.removeItem(_)}catch{}}var $=[0,1.1,1.2,1.3,1.4,1.5],tt={SCRIPT:1,STYLE:1,NOSCRIPT:1,IFRAME:1,TEMPLATE:1,VIDEO:1,AUDIO:1,CANVAS:1,SVG:1},G=new WeakMap,U=new Set,q=0,A=null,W=0;function et(t){for(let e=t.firstChild;e;e=e.nextSibling)if(e.nodeType===3&&e.nodeValue.trim())return!0;return!1}function nt(t){let e=G.get(t);if(!e){let n=parseFloat(getComputedStyle(t).fontSize);if(!n)return;e={inline:t.style.fontSize,px:n},G.set(t,e)}t.style.setProperty("font-size",(e.px*q).toFixed(2)+"px","important"),U.add(t)}function ot(t){if(!t||t.nodeType!==1||tt[t.tagName]||t.id==="ngsh-root")return;et(t)&&nt(t);let e=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(o){return tt[o.tagName]||o.id==="ngsh-root"?NodeFilter.FILTER_REJECT:et(o)?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),n;for(;n=e.nextNode();)nt(n)}function it(t){q=$[t]||$[1],ot(document.body),A||(A=new MutationObserver(()=>{clearTimeout(W),W=setTimeout(()=>ot(document.body),300)}),A.observe(document.body,{childList:!0,subtree:!0}))}function rt(){A&&(A.disconnect(),A=null),clearTimeout(W),U.forEach(t=>{let e=G.get(t);e&&(e.inline?t.style.fontSize=e.inline:t.style.removeProperty("font-size"))}),U=new Set,q=0}var g=null,M=0,at=0;function st(t){at=t.clientY,!M&&(M=requestAnimationFrame(()=>{M=0,g&&(g.style.top=at+14+"px")}))}function lt(){g||(g=document.createElement("div"),g.id="ngsh-guide",g.setAttribute("aria-hidden","true"),g.style.top="50%",document.body.appendChild(g),document.addEventListener("mousemove",st,{passive:!0}))}function dt(){document.removeEventListener("mousemove",st),M&&cancelAnimationFrame(M),M=0,g&&g.remove(),g=null}var a={widgetLabel:"\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",openMenu:"\u05E4\u05EA\u05D7 \u05EA\u05E4\u05E8\u05D9\u05D8 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",closeMenu:"\u05E1\u05D2\u05D5\u05E8 \u05EA\u05E4\u05E8\u05D9\u05D8 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",menuTitle:"\u05EA\u05E4\u05E8\u05D9\u05D8 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",reset:"\u05D0\u05D9\u05E4\u05D5\u05E1 \u05D4\u05D2\u05D3\u05E8\u05D5\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",statement:"\u05D4\u05E6\u05D4\u05E8\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",back:"\u05D7\u05D6\u05E8\u05D4 \u05DC\u05EA\u05E4\u05E8\u05D9\u05D8",print:"\u05D4\u05D3\u05E4\u05E1\u05EA \u05D4\u05D4\u05E6\u05D4\u05E8\u05D4",level:"\u05E8\u05DE\u05D4",expiredTooltip:"\u05E9\u05D9\u05E8\u05D5\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05D0\u05D9\u05E0\u05D5 \u05E4\u05E2\u05D9\u05DC",expiredTitle:"\u05D4\u05DE\u05E0\u05D5\u05D9 \u05D0\u05D9\u05E0\u05D5 \u05E4\u05E2\u05D9\u05DC",expiredBody:"\u05E9\u05D9\u05E8\u05D5\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05D1\u05D0\u05EA\u05E8 \u05D6\u05D4 \u05DE\u05D5\u05E9\u05D4\u05D4 \u05DB\u05E8\u05D2\u05E2. \u05D1\u05E2\u05DC \u05D4\u05D0\u05EA\u05E8 \u05DE\u05EA\u05D1\u05E7\u05E9 \u05DC\u05D7\u05D3\u05E9 \u05D0\u05EA \u05D4\u05DE\u05E0\u05D5\u05D9 \u05DB\u05D3\u05D9 \u05DC\u05D4\u05E4\u05E2\u05D9\u05DC \u05DE\u05D7\u05D3\u05E9 \u05D0\u05EA \u05DB\u05DC\u05D9 \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA.",activeBrand:"Negishut \xB7 \u05DB\u05DC\u05D9 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05E4\u05E2\u05D9\u05DC",expiredBrand:"Negishut \xB7 \u05D4\u05E9\u05D9\u05E8\u05D5\u05EA \u05DE\u05D5\u05E9\u05D4\u05D4",missingAlt:"\u05D7\u05E1\u05E8 \u05EA\u05D9\u05D0\u05D5\u05E8 \u05DC\u05EA\u05DE\u05D5\u05E0\u05D4",skipToContent:"\u05D3\u05DC\u05D2 \u05DC\u05EA\u05D5\u05DB\u05DF \u05D4\u05DE\u05E8\u05DB\u05D6\u05D9",features:{fontSize:"\u05D4\u05D2\u05D3\u05DC\u05EA \u05D8\u05E7\u05E1\u05D8",zoom:"\u05D6\u05D5\u05DD \u05EA\u05E6\u05D5\u05D2\u05D4",contrastDark:"\u05E0\u05D9\u05D2\u05D5\u05D3\u05D9\u05D5\u05EA \u05DB\u05D4\u05D4",contrastLight:"\u05E0\u05D9\u05D2\u05D5\u05D3\u05D9\u05D5\u05EA \u05D1\u05D4\u05D9\u05E8\u05D4",invert:"\u05D4\u05D9\u05E4\u05D5\u05DA \u05E6\u05D1\u05E2\u05D9\u05DD",gray:"\u05D2\u05D5\u05D5\u05E0\u05D9 \u05D0\u05E4\u05D5\u05E8",font:"\u05E4\u05D5\u05E0\u05D8 \u05E7\u05E8\u05D9\u05D0",links:"\u05D4\u05D3\u05D2\u05E9\u05EA \u05E7\u05D9\u05E9\u05D5\u05E8\u05D9\u05DD",spacing:"\u05E8\u05D9\u05D5\u05D5\u05D7 \u05D8\u05E7\u05E1\u05D8",cursor:"\u05E1\u05DE\u05DF \u05D2\u05D3\u05D5\u05DC",kbfocus:"\u05E0\u05D9\u05D5\u05D5\u05D8 \u05DE\u05E7\u05DC\u05D3\u05EA",noanim:"\u05E2\u05E6\u05D9\u05E8\u05EA \u05D4\u05D1\u05D4\u05D5\u05D1\u05D9\u05DD",guide:"\u05E1\u05E8\u05D2\u05DC \u05E7\u05E8\u05D9\u05D0\u05D4",alts:"\u05EA\u05D9\u05D0\u05D5\u05E8\u05D9 \u05EA\u05DE\u05D5\u05E0\u05D5\u05EA"}};function ct(t){let e=(t.org||"\u05D1\u05E2\u05DC\u05D9 \u05D4\u05D0\u05EA\u05E8").trim()||"\u05D1\u05E2\u05DC\u05D9 \u05D4\u05D0\u05EA\u05E8",n=[];n.push({ps:[e+" \u05E8\u05D5\u05D0\u05D9\u05DD \u05D7\u05E9\u05D9\u05D1\u05D5\u05EA \u05E8\u05D1\u05D4 \u05D1\u05DE\u05EA\u05DF \u05E9\u05D9\u05E8\u05D5\u05EA \u05E9\u05D5\u05D5\u05D9\u05D5\u05E0\u05D9, \u05DE\u05DB\u05D1\u05D3, \u05E0\u05D2\u05D9\u05E9 \u05D5\u05DE\u05E7\u05E6\u05D5\u05E2\u05D9 \u05DC\u05DB\u05DC\u05DC \u05D4\u05DC\u05E7\u05D5\u05D7\u05D5\u05EA \u05D5\u05D4\u05D2\u05D5\u05DC\u05E9\u05D9\u05DD, \u05D5\u05D1\u05DB\u05DC\u05DC \u05D6\u05D4 \u05D0\u05E0\u05E9\u05D9\u05DD \u05E2\u05DD \u05DE\u05D5\u05D2\u05D1\u05DC\u05D5\u05EA, \u05DE\u05EA\u05D5\u05DA \u05D0\u05DE\u05D5\u05E0\u05D4 \u05DB\u05D9 \u05DC\u05DB\u05DC \u05D0\u05D3\u05DD \u05DE\u05D2\u05D9\u05E2\u05D4 \u05D4\u05D6\u05DB\u05D5\u05EA \u05DC\u05D7\u05D9\u05D5\u05EA \u05D1\u05E9\u05D5\u05D5\u05D9\u05D5\u05DF, \u05D1\u05DB\u05D1\u05D5\u05D3, \u05D1\u05E0\u05D5\u05D7\u05D5\u05EA \u05D5\u05D1\u05E2\u05E6\u05DE\u05D0\u05D5\u05EA.",'\u05D4\u05E6\u05D4\u05E8\u05D4 \u05D6\u05D5 \u05E0\u05DB\u05EA\u05D1\u05D4 \u05D1\u05D4\u05EA\u05D0\u05DD \u05DC\u05D7\u05D5\u05E7 \u05E9\u05D5\u05D5\u05D9\u05D5\u05DF \u05D6\u05DB\u05D5\u05D9\u05D5\u05EA \u05DC\u05D0\u05E0\u05E9\u05D9\u05DD \u05E2\u05DD \u05DE\u05D5\u05D2\u05D1\u05DC\u05D5\u05EA, \u05D4\u05EA\u05E9\u05E0"\u05D7-1998, \u05D5\u05DC\u05EA\u05E7\u05E0\u05D5\u05EA \u05E9\u05D5\u05D5\u05D9\u05D5\u05DF \u05D6\u05DB\u05D5\u05D9\u05D5\u05EA \u05DC\u05D0\u05E0\u05E9\u05D9\u05DD \u05E2\u05DD \u05DE\u05D5\u05D2\u05D1\u05DC\u05D5\u05EA (\u05D4\u05EA\u05D0\u05DE\u05D5\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05DC\u05E9\u05D9\u05E8\u05D5\u05EA), \u05D4\u05EA\u05E9\u05E2"\u05D2-2013.']}),n.push({h:"\u05D4\u05E0\u05D2\u05E9\u05EA \u05D4\u05D0\u05EA\u05E8",ps:['\u05D0\u05E0\u05D5 \u05E4\u05D5\u05E2\u05DC\u05D9\u05DD \u05DC\u05D4\u05E0\u05D2\u05E9\u05EA \u05D4\u05D0\u05EA\u05E8 \u05D1\u05D4\u05EA\u05D0\u05DD \u05DC\u05EA\u05E7\u05DF \u05D4\u05D9\u05E9\u05E8\u05D0\u05DC\u05D9 \u05EA"\u05D9 5568 "\u05E7\u05D5\u05D5\u05D9\u05DD \u05DE\u05E0\u05D7\u05D9\u05DD \u05DC\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05EA\u05DB\u05E0\u05D9\u05DD \u05D1\u05D0\u05D9\u05E0\u05D8\u05E8\u05E0\u05D8" \u05D1\u05E8\u05DE\u05EA AA, \u05D4\u05DE\u05D1\u05D5\u05E1\u05E1 \u05E2\u05DC \u05D4\u05E0\u05D7\u05D9\u05D5\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA WCAG 2.0 \u05E9\u05DC \u05D0\u05E8\u05D2\u05D5\u05DF W3C \u05D4\u05D1\u05D9\u05E0\u05DC\u05D0\u05D5\u05DE\u05D9.',"\u05D1\u05D0\u05EA\u05E8 \u05DE\u05D5\u05D8\u05DE\u05E2 \u05E8\u05DB\u05D9\u05D1 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05D4\u05DE\u05D0\u05E4\u05E9\u05E8, \u05D1\u05D9\u05DF \u05D4\u05D9\u05EA\u05E8: \u05D4\u05D2\u05D3\u05DC\u05EA \u05D8\u05E7\u05E1\u05D8 \u05D5\u05D6\u05D5\u05DD \u05EA\u05E6\u05D5\u05D2\u05D4, \u05D4\u05EA\u05D0\u05DE\u05EA \u05E0\u05D9\u05D2\u05D5\u05D3\u05D9\u05D5\u05EA \u05D5\u05D4\u05D9\u05E4\u05D5\u05DA \u05E6\u05D1\u05E2\u05D9\u05DD, \u05D2\u05D5\u05E4\u05DF \u05E7\u05E8\u05D9\u05D0, \u05D4\u05D3\u05D2\u05E9\u05EA \u05E7\u05D9\u05E9\u05D5\u05E8\u05D9\u05DD, \u05E8\u05D9\u05D5\u05D5\u05D7 \u05D8\u05E7\u05E1\u05D8, \u05E1\u05DE\u05DF \u05E2\u05DB\u05D1\u05E8 \u05DE\u05D5\u05D2\u05D3\u05DC, \u05D4\u05D1\u05DC\u05D8\u05EA \u05DE\u05D9\u05E7\u05D5\u05D3 \u05DE\u05E7\u05DC\u05D3\u05EA, \u05E2\u05E6\u05D9\u05E8\u05EA \u05D0\u05E0\u05D9\u05DE\u05E6\u05D9\u05D5\u05EA \u05D5\u05D4\u05D1\u05D4\u05D5\u05D1\u05D9\u05DD, \u05E1\u05E8\u05D2\u05DC \u05E7\u05E8\u05D9\u05D0\u05D4, \u05D4\u05E6\u05D2\u05EA \u05EA\u05D9\u05D0\u05D5\u05E8\u05D9 \u05EA\u05DE\u05D5\u05E0\u05D5\u05EA \u05D5\u05E7\u05D9\u05E9\u05D5\u05E8 \u05D3\u05D9\u05DC\u05D5\u05D2 \u05DC\u05EA\u05D5\u05DB\u05DF \u05D4\u05DE\u05E8\u05DB\u05D6\u05D9. \u05D4\u05D4\u05D2\u05D3\u05E8\u05D5\u05EA \u05E0\u05E9\u05DE\u05E8\u05D5\u05EA \u05D1\u05D3\u05E4\u05D3\u05E4\u05DF \u05D4\u05D2\u05D5\u05DC\u05E9."]}),n.push({h:"\u05DE\u05D2\u05D1\u05DC\u05D5\u05EA \u05D9\u05D3\u05D5\u05E2\u05D5\u05EA",ps:["\u05D0\u05E0\u05D5 \u05E2\u05D5\u05E9\u05D9\u05DD \u05DB\u05DC \u05DE\u05D0\u05DE\u05E5 \u05DC\u05D4\u05E0\u05D2\u05D9\u05E9 \u05D0\u05EA \u05DB\u05DC\u05DC \u05D4\u05D3\u05E4\u05D9\u05DD \u05D5\u05D4\u05EA\u05DB\u05E0\u05D9\u05DD \u05D1\u05D0\u05EA\u05E8. \u05E2\u05DD \u05D6\u05D0\u05EA, \u05D9\u05D9\u05EA\u05DB\u05DF \u05E9\u05D9\u05D9\u05DE\u05E6\u05D0\u05D5 \u05D7\u05DC\u05E7\u05D9\u05DD \u05D0\u05D5 \u05EA\u05DB\u05E0\u05D9\u05DD \u05E9\u05D8\u05E8\u05DD \u05D4\u05D5\u05E0\u05D2\u05E9\u05D5 \u05D1\u05DE\u05DC\u05D5\u05D0\u05DD, \u05DC\u05E8\u05D1\u05D5\u05EA \u05EA\u05DB\u05E0\u05D9\u05DD \u05D4\u05DE\u05E1\u05D5\u05E4\u05E7\u05D9\u05DD \u05E2\u05DC \u05D9\u05D3\u05D9 \u05E6\u05D3\u05D3\u05D9\u05DD \u05E9\u05DC\u05D9\u05E9\u05D9\u05D9\u05DD. \u05D0\u05DD \u05E0\u05EA\u05E7\u05DC\u05EA\u05DD \u05D1\u05D1\u05E2\u05D9\u05D9\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u2013 \u05E0\u05E9\u05DE\u05D7 \u05E9\u05EA\u05E2\u05D3\u05DB\u05E0\u05D5 \u05D0\u05D5\u05EA\u05E0\u05D5 \u05D5\u05E0\u05E4\u05E2\u05DC \u05DC\u05EA\u05D9\u05E7\u05D5\u05E0\u05D4 \u05D1\u05D4\u05E7\u05D3\u05DD \u05D4\u05D0\u05E4\u05E9\u05E8\u05D9."]});let o=[];t.coordinatorName&&o.push("\u05E9\u05DD: "+t.coordinatorName),t.coordinatorPhone&&o.push("\u05D8\u05DC\u05E4\u05D5\u05DF: "+t.coordinatorPhone),t.coordinatorEmail&&o.push('\u05D3\u05D5\u05D0"\u05DC: '+t.coordinatorEmail),o.length&&n.push({h:"\u05E8\u05DB\u05D6/\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",ps:["\u05DC\u05DB\u05DC \u05E9\u05D0\u05DC\u05D4, \u05D1\u05E7\u05E9\u05D4 \u05D0\u05D5 \u05D3\u05D9\u05D5\u05D5\u05D7 \u05D1\u05E0\u05D5\u05E9\u05D0 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05E0\u05D9\u05EA\u05DF \u05DC\u05E4\u05E0\u05D5\u05EA \u05D0\u05DC \u05E8\u05DB\u05D6/\u05EA \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05E9\u05DC\u05E0\u05D5:"],list:o}),n.push({h:"\u05DE\u05E9\u05D5\u05D1 \u05D5\u05E4\u05E0\u05D9\u05D5\u05EA \u05D1\u05E0\u05D5\u05E9\u05D0 \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA",ps:["\u05D0\u05DD \u05E0\u05EA\u05E7\u05DC\u05EA\u05DD \u05D1\u05E7\u05D5\u05E9\u05D9 \u05D1\u05D2\u05DC\u05D9\u05E9\u05D4 \u05D1\u05D0\u05EA\u05E8 \u05D0\u05D5 \u05D1\u05E7\u05D1\u05DC\u05EA \u05E9\u05D9\u05E8\u05D5\u05EA, \u05E0\u05E9\u05DE\u05D7 \u05D0\u05DD \u05EA\u05E4\u05E0\u05D5 \u05D0\u05DC\u05D9\u05E0\u05D5"+(o.length?" \u05D1\u05D0\u05DE\u05E6\u05E2\u05D5\u05EA \u05E4\u05E8\u05D8\u05D9 \u05D4\u05E7\u05E9\u05E8 \u05E9\u05DC\u05E2\u05D9\u05DC":"")+". \u05D0\u05E0\u05D0 \u05E6\u05E8\u05E4\u05D5 \u05EA\u05D9\u05D0\u05D5\u05E8 \u05E9\u05DC \u05D4\u05D1\u05E2\u05D9\u05D4, \u05DB\u05EA\u05D5\u05D1\u05EA \u05D4\u05D3\u05E3 \u05E9\u05D1\u05D5 \u05E0\u05EA\u05E7\u05DC\u05EA\u05DD \u05D1\u05D4, \u05D5\u05E1\u05D5\u05D2 \u05D4\u05D3\u05E4\u05D3\u05E4\u05DF \u05D5\u05D4\u05D8\u05DB\u05E0\u05D5\u05DC\u05D5\u05D2\u05D9\u05D4 \u05D4\u05DE\u05E1\u05D9\u05D9\u05E2\u05EA \u05E9\u05D1\u05D4\u05DD \u05D4\u05E9\u05EA\u05DE\u05E9\u05EA\u05DD \u2013 \u05DB\u05DA \u05E0\u05D5\u05DB\u05DC \u05DC\u05D8\u05E4\u05DC \u05D1\u05E4\u05E0\u05D9\u05D9\u05D4 \u05D1\u05D9\u05E2\u05D9\u05DC\u05D5\u05EA."]});let r=t.statementDate?"\u05D4\u05D4\u05E6\u05D4\u05E8\u05D4 \u05E2\u05D5\u05D3\u05DB\u05E0\u05D4 \u05DC\u05D0\u05D7\u05E8\u05D5\u05E0\u05D4 \u05D1\u05EA\u05D0\u05E8\u05D9\u05DA: "+t.statementDate:"",i=[];return r&&i.push(r),i.push("\u05D4\u05E6\u05D4\u05E8\u05D4 \u05D6\u05D5 \u05D4\u05D5\u05E4\u05E7\u05D4 \u05D1\u05D0\u05DE\u05E6\u05E2\u05D5\u05EA \u05E8\u05DB\u05D9\u05D1 \u05D4\u05E0\u05D2\u05D9\u05E9\u05D5\u05EA Negishut. \u05D4\u05D0\u05D7\u05E8\u05D9\u05D5\u05EA \u05D4\u05DE\u05E9\u05E4\u05D8\u05D9\u05EA \u05E2\u05DC \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05D4\u05D0\u05EA\u05E8 \u05D5\u05EA\u05DB\u05E0\u05D9\u05D5 \u05D7\u05DC\u05D4 \u05E2\u05DC \u05D1\u05E2\u05DC\u05D9 \u05D4\u05D0\u05EA\u05E8."),n.push({ps:i}),n}var K=[],F=null;function mt(){K.forEach(t=>t.remove()),K=[]}function pt(){mt(),document.querySelectorAll("img").forEach(t=>{let e=t.getBoundingClientRect();if(e.width<40||e.height<40)return;let n=(t.getAttribute("alt")||"").trim(),o=document.createElement("div");o.className="ngsh-alt-badge"+(n?"":" ngsh-alt-missing"),o.setAttribute("aria-hidden","true"),o.textContent=n||a.missingAlt,o.style.top=e.top+window.scrollY+4+"px",o.style.left=e.left+window.scrollX+4+"px",document.body.appendChild(o),K.push(o)})}function ut(){pt();let t=0;F=()=>{clearTimeout(t),t=setTimeout(pt,400)},window.addEventListener("resize",F)}function ht(){F&&window.removeEventListener("resize",F),F=null,mt()}function ft(){document.querySelectorAll("video, audio").forEach(t=>{try{t.paused||t.pause()}catch{}})}var N=document.documentElement;function v(t){return{apply:()=>N.classList.add("ngsh-"+t),remove:()=>N.classList.remove("ngsh-"+t)}}function Ot(t,e){let n=()=>{for(let o=1;o<=e;o++)N.classList.remove("ngsh-"+t+"-"+o)};return{apply:o=>{n(),o>0&&N.classList.add("ngsh-"+t+"-"+o)},remove:n}}var P=[{id:"fontSize",kind:"steps",max:5,icon:"fontSize",apply:it,remove:rt},{id:"zoom",kind:"steps",max:3,icon:"zoom",...Ot("zoom",3)},{id:"contrastDark",kind:"toggle",group:"colors",icon:"moon",...v("contrast-dark")},{id:"contrastLight",kind:"toggle",group:"colors",icon:"sun",...v("contrast-light")},{id:"invert",kind:"toggle",group:"colors",icon:"invert",...v("invert")},{id:"gray",kind:"toggle",group:"colors",icon:"gray",...v("gray")},{id:"font",kind:"toggle",icon:"font",...v("font")},{id:"links",kind:"toggle",icon:"link",...v("links")},{id:"spacing",kind:"toggle",icon:"spacing",...v("spacing")},{id:"cursor",kind:"toggle",icon:"cursor",...v("cursor")},{id:"kbfocus",kind:"toggle",icon:"keyboard",...v("kbfocus")},{id:"noanim",kind:"toggle",icon:"pause",apply(){N.classList.add("ngsh-noanim"),ft()},remove(){N.classList.remove("ngsh-noanim")}},{id:"guide",kind:"toggle",icon:"ruler",apply:lt,remove:dt},{id:"alts",kind:"toggle",icon:"image",apply:ut,remove:ht}],p={};function gt(){p=Q(),P.forEach(t=>{let e=p[t.id];if(e)try{t.apply(e===!0?void 0:Number(e))}catch{delete p[t.id]}})}function bt(t){return p[t]||0}function xt(t){if(t.kind==="steps"){let n=((Number(p[t.id])||0)+1)%(t.max+1);n===0?(t.remove(),delete p[t.id]):(t.apply(n),p[t.id]=n)}else p[t.id]?(t.remove(),delete p[t.id]):(t.group&&P.forEach(e=>{e!==t&&e.group===t.group&&p[e.id]&&(e.remove(),delete p[e.id])}),t.apply(),p[t.id]=!0);j(p)}function Ct(){P.forEach(t=>{p[t.id]&&t.remove()}),p={},j(p)}function vt(){if(document.querySelector("a.ngsh-skip"))return;let t=document.querySelector('main, [role="main"]')||document.getElementById("main")||document.getElementById("content")||document.getElementById("primary")||document.querySelector("h1");if(!t)return;t.id||(t.id="ngsh-main"),t.hasAttribute("tabindex")||t.setAttribute("tabindex","-1");let e=document.createElement("a");e.className="ngsh-skip",e.href="#"+t.id,e.textContent=a.skipToContent,e.addEventListener("click",()=>{try{t.focus()}catch{}}),document.body.insertBefore(e,document.body.firstChild)}var Y=`:host {
  all: initial;
}
* {
...
`;var yt=`<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 2048 2048">\r
...
</svg>`;var kt="http://www.w3.org/2000/svg",zt={person:"M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm9 7h-6v13h-2v-6h-2v6H9V9H3V7h18v2z",close:"M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z",back:"M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z",doc:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z",print:"M19 8H5a3 3 0 0 0-3 3v6h4v4h12v-4h4v-6a3 3 0 0 0-3-3zm-3 11H8v-5h8v5zm3-7a1 1 0 1 1 0-2 1 1 0 0 1 0 2zM18 3H6v4h12V3z",reset:"M17.65 6.35A7.95 7.95 0 0 0 12 4a8 8 0 1 0 8 8h-2a6 6 0 1 1-1.76-4.24L13 11h7V4l-2.35 2.35z",fontSize:"M9 4v3h5v12h3V7h5V4H9zM3 12h3v7h3v-7h3V9H3v3z",zoom:"M15.5 14h-.79l-.28-.27A6.47 6.47 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14zm2.5-4h-2v2H9v-2H7V9h2V7h1v2h2v1z",moon:"M12 3a9 9 0 1 0 9 9c0-.46-.04-.92-.1-1.36a5.39 5.39 0 0 1-4.4 2.26 5.4 5.4 0 0 1-3.14-9.8c-.44-.06-.9-.1-1.36-.1z",sun:"M12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0-5 2.39 3.61h-4.78L12 2zm0 20-2.39-3.61h4.78L12 22zM2 12l3.61-2.39v4.78L2 12zm20 0-3.61 2.39V9.61L22 12z",invert:"M17.66 7.93 12 2.27 6.34 7.93a8 8 0 1 0 11.32 0zM12 19.59c-1.6 0-3.11-.62-4.24-1.76A5.95 5.95 0 0 1 6 13.59c0-1.6.62-3.11 1.76-4.24L12 5.1v14.49z",gray:"M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 18V4a8 8 0 0 1 0 16z",font:"M5 4v3h5.5v12h3V7H19V4H5z",link:"M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7a5 5 0 0 0 0 10h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4a5 5 0 0 0 0-10z",spacing:"M6 7h2.5L5 3.5 1.5 7H4v10H1.5L5 20.5 8.5 17H6V7zm4-2v2h12V5H10zm0 14h12v-2H10v2zm0-6h12v-2H10v2z",cursor:"M6 2l13 11.5h-7.8L8.6 21z",keyboard:"M20 5H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zM8 9h2v2H8V9zm0 3h2v2H8v-2zM5 9h2v2H5V9zm0 3h2v2H5v-2zm11 5H8v-2h8v2zm3-3h-2v-2h2v2zm0-3h-2V9h2v2zm-5-2h2v2h-2V9zm0 3h2v2h-2v-2z",pause:"M6 19h4V5H6v14zm8-14v14h4V5h-4z",ruler:"M2 16h20v5H2v-5zm3 1v2h1v-2H5zm4 0v2h1v-2H9zm4 0v2h1v-2h-1zm4 0v2h1v-2h-1zM4 3h7v10H4z",image:"M21 19V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2zM8.5 13.5l2.5 3 3.5-4.5 4.5 6H5l3.5-4.5z"};function b(t,e){let n=document.createElementNS(kt,"svg");n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("width",e||24),n.setAttribute("height",e||24),n.setAttribute("fill","currentColor"),n.setAttribute("aria-hidden","true"),n.setAttribute("focusable","false");let o=document.createElementNS(kt,"path");return o.setAttribute("d",zt[t]||zt.doc),n.appendChild(o),n}function Lt(t,e){let n=e.createDocumentFragment();return ct(t).forEach(o=>{if(o.h){let r=e.createElement("h3");r.textContent=o.h,n.appendChild(r)}if((o.ps||[]).forEach(r=>{let i=e.createElement("p");i.textContent=r,n.appendChild(i)}),o.list){let r=e.createElement("ul");o.list.forEach(i=>{let s=e.createElement("li");s.textContent=i,r.appendChild(s)}),n.appendChild(r)}}),n}function jt(t){let e=document.createElement("iframe");e.setAttribute("aria-hidden","true"),e.style.cssText="position:fixed;width:0;height:0;border:0;visibility:hidden;",document.body.appendChild(e);let n=e.contentDocument;n.open(),n.write('<!doctype html><html dir="rtl" lang="he"><head><meta charset="utf-8"><title>\u05D4\u05E6\u05D4\u05E8\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA</title></head><body></body></html>'),n.close();let o=n.createElement("style");o.textContent="body{font-family:Arial,sans-serif;line-height:1.7;padding:28px;color:#000}h1{font-size:22px;margin-bottom:12px}h3{font-size:16px;margin:16px 0 4px}p{margin:6px 0}ul{margin:6px 24px 6px 0}",n.head.appendChild(o);let r=n.createElement("h1");r.textContent=a.statement,n.body.appendChild(r),n.body.appendChild(Lt(t,n)),e.contentWindow.focus(),e.contentWindow.print(),setTimeout(()=>e.remove(),3e3)}function Et(t){let e=document.createElement("div");e.className="statement",e.appendChild(Lt(t,document));let n=document.createElement("button");n.type="button",n.className="wide",n.appendChild(b("print",18));let o=document.createElement("span");return o.textContent=a.print,n.appendChild(o),n.addEventListener("click",()=>jt(t)),e.appendChild(n),e}function wt(t,e){let n=document.createElement("div");n.className="panel",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label",a.menuTitle),n.hidden=!0;let o=document.createElement("div");o.className="header";let r=document.createElement("h2");r.textContent=a.menuTitle;let i=document.createElement("div");i.className="hbtns";let s=document.createElement("button");s.type="button",s.className="iconbtn",s.setAttribute("aria-label",a.back),s.appendChild(b("back",20)),s.hidden=!0;let l=document.createElement("button");l.type="button",l.className="iconbtn",l.setAttribute("aria-label",a.closeMenu),l.appendChild(b("close",20)),l.addEventListener("click",e),i.appendChild(s),i.appendChild(l),o.appendChild(r),o.appendChild(i),n.appendChild(o);let f=document.createElement("div"),H=document.createElement("div");H.className="grid";let E=[];P.forEach(c=>{let u=document.createElement("button");u.type="button",u.className="tile",c.kind==="toggle"&&u.setAttribute("role","switch"),u.appendChild(b(c.icon,24));let J=document.createElement("span");J.textContent=a.features[c.id],u.appendChild(J);let S=null;if(c.kind==="steps"){S=document.createElement("span"),S.className="steps",S.setAttribute("aria-hidden","true");for(let k=0;k<c.max;k++)S.appendChild(document.createElement("span"));u.appendChild(S)}let X=()=>{let k=bt(c.id);if(c.kind==="toggle")u.setAttribute("aria-checked",k?"true":"false"),u.classList.toggle("on",!!k);else{let O=Number(k)||0;u.classList.toggle("on",O>0),u.setAttribute("aria-label",a.features[c.id]+", "+a.level+" "+O+" \u05DE\u05EA\u05D5\u05DA "+c.max),Array.prototype.forEach.call(S.children,(Vt,It)=>Vt.classList.toggle("f",It<O))}};u.addEventListener("click",()=>{xt(c),E.forEach(k=>k())}),E.push(X),X(),H.appendChild(u)}),f.appendChild(H);let z=document.createElement("div");z.className="footer";let h;t.statementUrl?(h=document.createElement("a"),h.href=t.statementUrl,h.target="_blank",h.rel="noopener"):(h=document.createElement("button"),h.type="button"),h.className="wide",h.appendChild(b("doc",18));let L=document.createElement("span");L.textContent=a.statement,h.appendChild(L),z.appendChild(h);let y=document.createElement("button");y.type="button",y.className="wide",y.appendChild(b("reset",18));let d=document.createElement("span");d.textContent=a.reset,y.appendChild(d),y.addEventListener("click",()=>{Ct(),E.forEach(c=>c())}),z.appendChild(y),f.appendChild(z),n.appendChild(f);let m=null,x=document.createElement("div");x.className="expired-box";let T=document.createElement("h3");T.textContent=a.expiredTitle;let w=document.createElement("p");w.textContent=a.expiredBody,x.appendChild(T),x.appendChild(w),x.hidden=!0,n.appendChild(x);let V=document.createElement("div");V.className="brand",V.textContent=a.activeBrand,n.appendChild(V);function B(c){f.hidden=c!=="menu",m&&(m.hidden=c!=="statement"),x.hidden=c!=="expired",s.hidden=c!=="statement"}t.statementUrl||h.addEventListener("click",()=>{m||(m=Et(t),m.hidden=!0,n.insertBefore(m,x)),B("statement"),s.focus()}),s.addEventListener("click",()=>{B("menu"),l.focus()});function Ht(c){c==="expired"?(B("expired"),V.textContent=a.expiredBrand):(B("menu"),V.textContent=a.activeBrand,E.forEach(u=>u()))}function Tt(){l.focus()}return{el:n,refresh:Ht,focusFirst:Tt}}function Gt(){try{let e=new DOMParser().parseFromString(yt,"image/svg+xml").documentElement;return e.nodeName!=="svg"?b("person",32):(e.setAttribute("width","40"),e.setAttribute("height","40"),e.setAttribute("aria-hidden","true"),e.setAttribute("focusable","false"),document.importNode(e,!0))}catch{return b("person",32)}}function St(t){let e=document.createElement("div");e.id="ngsh-root";let n=t.position==="bottom-left"?"left":"right";e.style.cssText="position:fixed;bottom:16px;"+n+":16px;z-index:2147483646;";let o=e.attachShadow({mode:"open"});try{let d=new CSSStyleSheet;d.replaceSync(Y),o.adoptedStyleSheets=[d]}catch{let m=document.createElement("style");m.textContent=Y,o.appendChild(m)}let r=document.createElement("div");r.className="wrap pos-"+n,r.setAttribute("dir","rtl"),r.setAttribute("lang","he");let i=document.createElement("button");i.type="button",i.className="btn",i.title=a.widgetLabel,i.setAttribute("aria-label",a.openMenu),i.setAttribute("aria-haspopup","dialog"),i.setAttribute("aria-expanded","false"),i.appendChild(Gt()),r.appendChild(i),o.appendChild(r);let s=null,l=!1,f="active";function H(){return s.el.querySelectorAll("button:not([hidden]), a[href]")}function E(d){if(!l)return;if(d.key==="Escape"){d.stopPropagation(),L();return}if(d.key!=="Tab")return;let m=H();if(!m.length)return;let x=m[0],T=m[m.length-1],w=o.activeElement;d.shiftKey&&(w===x||!w)?(d.preventDefault(),T.focus()):!d.shiftKey&&w===T&&(d.preventDefault(),x.focus())}function z(d){l&&d.composedPath&&!d.composedPath().includes(e)&&L()}function h(){s||(s=wt(t,L),r.appendChild(s.el),s.el.addEventListener("keydown",E)),s.refresh(f),s.el.hidden=!1,l=!0,i.setAttribute("aria-expanded","true"),i.setAttribute("aria-label",a.closeMenu),s.focusFirst(),document.addEventListener("click",z,!0)}function L(){s&&(s.el.hidden=!0,l=!1,i.setAttribute("aria-expanded","false"),i.setAttribute("aria-label",a.openMenu),document.removeEventListener("click",z,!0),i.focus())}i.addEventListener("click",()=>l?L():h());function y(d){f=d==="expired"?"expired":"active",r.classList.toggle("expired",f==="expired"),i.title=f==="expired"?a.expiredTooltip:a.widgetLabel,l&&s.refresh(f)}return{host:e,setLicense:y}}var At="https://negishut-api.solaitions.workers.dev/v1/check",Mt="ngsh:lic:v1";function Nt(t,e){let n=null;try{n=JSON.parse(localStorage.getItem(Mt))}catch{}let o=n&&(n.v==="active"||n.v==="expired")?n.v:"active";e(o);let r=location.hostname;if(At.indexOf("NGSH_API_URL_")===0||!r||r==="localhost"||r==="127.0.0.1"||location.protocol==="file:"||n&&n.t&&Date.now()-n.t<1296e6)return;let i=null,s=0;try{i=new AbortController,s=setTimeout(()=>i.abort(),3e3)}catch{}fetch(At+"?site="+encodeURIComponent(r)+"&id="+encodeURIComponent(t.siteId||""),{mode:"cors",signal:i&&i.signal}).then(l=>l.ok?l.json():null).then(l=>{if(clearTimeout(s),!(!l||l.status!=="active"&&l.status!=="expired")){try{localStorage.setItem(Mt,JSON.stringify({v:l.status,t:Date.now()}))}catch{}l.status!==o&&e(l.status)}}).catch(()=>{clearTimeout(s)})}(function(){if(window.__ngshLoaded)return;window.__ngshLoaded=!0;function t(){try{let n=new CSSStyleSheet;n.replaceSync(R),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n]}catch{let o=document.createElement("style");o.setAttribute("data-ngsh",""),o.textContent=R,(document.head||document.documentElement).appendChild(o)}}function e(){t(),I.lang&&!document.documentElement.getAttribute("lang")&&document.documentElement.setAttribute("lang",I.lang),vt(),gt();let n=St(I);document.body.appendChild(n.host),Nt(I,n.setLicense)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();})();
